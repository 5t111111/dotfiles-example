...
# Load local config
################################################################################
[ -s ${ZDOTDIR}/local.zshrc ] && source ${ZDOTDIR}/local.zshrc

################################################################################
# Completions
# Ideally compinit should be called only once.
################################################################################
() {
  local completions_dir="${ZDOTDIR}/completions"
  source ${completions_dir}/completions.zsh
  autoload -Uz compinit && compinit
}

################################################################################
# Load hooks
# Hooks should be called at the end of zsh initialization because some hooks
# call compinit in it.
# Calling compinit multiple times causes performance issues.
################################################################################
() {
...
################################################################################
# Uncomment the following lines if you want to do profiling
################################################################################
